      ...
      <ScrollView style={{ padding: spacing[3] }}>
        ...
        <View style={{ marginBottom: spacing[4], padding: spacing[3] }}>
          <Icon
            ...
            color={colors}
          />
          <Lists title="Appointment" onPress={() => onPressBook()} />
        </View>

        {/* payment section */}
        {/* <View style={styles.field}>
          <Icon fontFamily={"MaterialIcons"} name="payment" color={colors} />
          <Lists title={i18n.t("Payment")} onPress={() => onPressPayment()} />
        </View> */}
        {/* privacy */}
        <View style={styles.field}>
          <Icon
